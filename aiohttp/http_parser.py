...
from .helpers import DEBUG, NO_EXTENSIONS, BaseTimerContext, set_exception
...
TOKENRE = re.compile("[0-9A-Za-z{}]+".format(_TCHAR_SPECIALS))
VERSRE = re.compile(r"HTTP/(\d)\.(\d)", re.ASCII)
